        ...
        <div>
          ...
          <div>
            <form class="form-inline" method="post">
              ...
              <input style="width:100px;" type="number" class="form-control" name="soluong" value="1" min='1' max='<?php echo $mhct["soluongton"]; ?>' required>
                    ...
                    <div class="details">
                      <h2><a href="?action=xemchitiet&mahang=<?php echo $m["id"]; ?>">
                        ...
                        <h2>
                          ...
                          <div class="data">
                            <h3 class="myH3">Giá bán : <span> <?php echo number_format($m["giaban"]); ?>đ</span></h3>
                          </div>
                    </div>
